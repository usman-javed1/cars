          ...
          <div className='aboutuscontact' style={{zIndex: 999}}>
            ...
            <div >
              <h2 className='class-for-h1 py-[20px] lg:w-[540px] w-[100%] text-[#FFFFFF] '>
                About Us: The Wheel Deal
              </h2>
              <p className='text-[14px]  font-[500] text-[#B9B9B9] lg:w-[400px] w-[100%] '>Welcome to The Wheel Deal, your trusted partner in car leasing. We are dedicated to offering you the best deals, the newest models, and a seamless leasing experience tailored to your needs. </p>
            </div>
